    ...
    while vidcap.isOpened():
        ...
        if success:
            if count%int(frame)==0:
                file_name = os.path.join(path_output_dir, 'drone_v2_%d.png') % numbering
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save", default="images", help="location of directory to save output images")
    parser.add_argument("--frame",  default=30, help="frame frequency how often to collect images.")
